...
<div class="container-fluid fill">
  <div class="row justify-content-center">
    <h1 class="p-3 mb-5 text-white">trevor dobbertin's asterisk</h1>
  </div>

  <div class="row">
    <div class="col-4">
      <div class="list-group" id="list-tab" role="tablist">
        <a class="list-group-item list-group-item-action active" id="list-overview-list" data-toggle="list" href="#list-overview" role="tab">Overview</a>
    ...
    <div class="col-8">
      <div class="tab-content" id="nav-tabContent">
        ...
        <div class="card bg-success text-center tab-pane fade" id="financialCard">
          <div class="card-body">
  ...
  <div class="modal fade" id="academicModal" tabindex="-1" role="dialog" aria-labelledby="financalModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="academicModalLabel">Financal Quiz</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
